...
// Circle avatar — for round spots (default).
...
// Square avatar — for square spots (rounded corners instead of a full circle).
const SquareAvatar = React.forwardRef<
  React.ElementRef<typeof AvatarPrimitive.Root>,
  React.ComponentPropsWithoutRef<typeof AvatarPrimitive.Root>
>(({ className, ...props }, ref) => (
  <AvatarPrimitive.Root
...
export { Avatar, SquareAvatar, AvatarFallback, AvatarImage };
